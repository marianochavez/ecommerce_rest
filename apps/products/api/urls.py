...
from apps.products.api.views.product_views import ProductRetrieveDestroyAPIView,ProductRetrieveUpdateAPIView
...
urlpatterns = [
    ...
    path("product/destroy/<int:pk>", ProductRetrieveDestroyAPIView.as_view(), name="product_destroy"),
    path("product/update/<int:pk>", ProductRetrieveUpdateAPIView.as_view(), name="product_update"),
]